...
const NotesPageLoggedInView = () => {
  ...
  return (
    <>
    <Button  onClick={() => setShowAddNoteDialog(true)} className={`mb-4 mt-4 ${styleUtils.blockCenter} ${styleUtils.flexCenter} `} >
      <FaPlus />
        Add New Note
        
      </Button>
      {notesLoading && <Spinner animation='border' variant='primary' />}
      {showNotesLoadingError && <p>Someting went wrong. Please refresh the page</p>}
